...
[![x-cmd/install — fresh Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/fresh.svg?lang=zh)](https://x-cmd.com/install/fresh)
...
合计: **743,290** 行代码（覆盖前 5 种语言、共 **1518** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 579,146 | 73,122 | 76,776 | 1279 |
| Json | 74,929 | 0 | 20 | 96 |
| TypeScript | 55,517 | 25,756 | 6,563 | 94 |
| Python | 9,608 | 533 | 1,536 | 40 |
| Svg | 8,582 | 19 | 7 | 9 |

## 源代码

- **上游仓库**: <https://github.com/sinelaw/fresh>
- **官网**: <https://getfresh.dev/>
- **许可证**: GPL-3.0
...
- **Star**: 9,007 · **Fork**: 343 · **开放 issue**: 1,233 · **贡献者**: 72

## 累计统计

- **发布数**: 107 · **已合并 PR**: 1827 · **开放 PR**: 75 · **已关闭 issue**: 936 · **开放 issue**: 297 · **提交数**: 8924

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 2 | 128 | 26 | 39 | 90 | 318 |
| last60d | 2026-07-26 | 6 | 284 | 38 | 95 | 121 | 902 |
| 90d | 2026-06-26 | 10 | 449 | 43 | 191 | 156 | 1514 |
| last180d | 2026-03-28 | 29 | 1114 | 67 | 465 | 229 | 4683 |
| 360d | 2025-09-29 | 100 | 1826 | 75 | 936 | 297 | 8790 |
| last720d | 2024-10-04 | 100 | 1827 | 75 | 936 | 297 | 8924 |
...
fresh 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `fresh` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/fresh.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:41:17Z._
